...
namespace AttendancePlatform.Authentication.Api.Services
{
    ...
    public class EmailService : IEmailService
    {
        ...
        public async Task<bool> SendPasswordResetEmailAsync(string email, string resetToken, string resetUrl)
        {
            try
            {
                var subject = "Password Reset Request - AttendancePro";
        ...
        public async Task<bool> SendWelcomeEmailAsync(string email, string firstName, string temporaryPassword)
        {
            try
            {
                var subject = "Welcome to AttendancePro";
        ...
        public async Task<bool> SendTwoFactorSetupEmailAsync(string email, string firstName, string qrCodeUri)
        {
            try
            {
                var subject = "Two-Factor Authentication Setup - AttendancePro";
        ...
        public async Task<bool> SendAccountLockedEmailAsync(string email, string firstName, DateTime lockedUntil)
        {
            try
            {
                var subject = "Account Temporarily Locked - AttendancePro";
        ...
        private async Task<bool> SendEmailAsync(string toEmail, string subject, string body)
        {
            try
            {
                ...
                var fromName = _configuration["SMTP_FROM_NAME"] ?? "AttendancePro System";
...
<body>
    <div class='container'>
        ...
        <div class='content'>
            <p>You have requested to reset your password for your AttendancePro account.</p>
...
<body>
    <div class='container'>
        ...
        <div class='content'>
            <p>Hello {firstName},</p>
            <p>Welcome to AttendancePro! Your account has been created successfully.</p>
            ...
            <p>You can access the system at: <a href='https://app.attendancepro.com'>https://app.attendancepro.com</a></p>
...
<body>
    <div class='container'>
        ...
        <div class='content'>
            <p>Hello {firstName},</p>
            <p>Two-factor authentication has been enabled for your AttendancePro account for enhanced security.</p>
...
<body>
    <div class='container'>
        ...
        <div class='content'>
            <p>Hello {firstName},</p>
            <div class='warning'>
                <p><strong>Your AttendancePro account has been temporarily locked due to multiple failed login attempts.</strong></p>
            </div>
