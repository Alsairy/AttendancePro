...
{
    public class ScimService_Fixed
    {
        private readonly ILogger<ScimService_Fixed> _logger;
        private readonly AttendancePlatformDbContext _context;

        public ScimService_Fixed(ILogger<ScimService_Fixed> logger, AttendancePlatformDbContext context)
        {
            _logger = logger;
            _context = context;
        }
