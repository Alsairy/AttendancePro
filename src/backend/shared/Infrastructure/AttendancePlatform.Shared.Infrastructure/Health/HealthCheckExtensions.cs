...
{
    public static IServiceCollection AddAttendanceProHealthChecks(this IServiceCollection services, string connectionString)
    {
    ...
    public static IApplicationBuilder UseAttendanceProHealthChecks(this IApplicationBuilder app)
    {
